...
namespace RedBeanPHP {
    ...
    interface QueryWriter
    {
         ...
         *
         * @param string $sourceType source type, the reference type you want to use to fetch related items on the
         *                           other side
...
namespace RedBeanPHP {
    ...
    class Finder
    {
         ...
         *       $a->clearHistory();                 //optional, act 'as if these beans have been loaded through
         *       ownReviewList'.
         *    }
         * )
